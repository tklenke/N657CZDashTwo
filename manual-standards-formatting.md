...
- `[tds/filename]` — the filename in the TDS reference folder
...
If a value cannot be traced to an authoritative source, flag it with `@@TOM:` rather than presenting it without attribution.

### Citations for Inspection Criteria and General Guidance
...
- Information provided directly by the operator (e.g., operator-specific dimensions, product preferences)

Parenthetical inline at end of sentence or bullet: `(AC 43.13, ch03_p020)`. Prose form is acceptable when it reads naturally: `per the procedure in AC 43.13, ch03_p040`.
