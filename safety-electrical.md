...
An inadvertent short across battery terminals can cause arcing, wiring damage, and fire. Short-circuit currents from aircraft batteries can cause serious structural and wiring damage (AC 43.13, ch11_p022).
...
After any work on electrical components or wiring (AC 43.13, ch11_p002):

- Inspect all disturbed wiring for chafed insulation, loose terminals, and proper routing.
- Verify no tools, hardware, or loose conductors remain in the aircraft.
- Confirm all circuit breakers are in the correct position before applying power.
