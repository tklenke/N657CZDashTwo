...
> **NOTE:** Two image embed formats are included below — one will render correctly in OtterWiki. @@TOM: Verify which format renders and remove the other.

[[/assets/diagrams/sec17-g3x-system-interconnect.svg]]
