...
Working aft from the nose cone:

- **Canard and elevator assembly** — full-span canard with elevators. Pitch servo mounted on the right fuselage side just aft of the canard.
- **Nose gear actuator** — electric, centerline-mounted under the canard.
- **Brake master cylinders and fluid reservoir** — mounted above the nose gear actuator.
...
The strakes are the fuselage side extensions at the wing roots that also serve as fuel tanks.

- **Fuel probes** — left and right strakes, on the aft baggage compartment wall.
- **Fuel level windows** — left and right sides of the fuselage, forward of the rear seats.
- **Fuel ports (supply and return)** — left and right sides of the fuselage, adjacent to the rear seats.
...
- GEA 24 engine data acquisition unit
- Lightspeed electronic ignition (primary)
- Main battery (ETX900-VNT)
- Main battery contactor
- Starter contactor
- LRE3E-14 primary alternator voltage regulator
- PMR1D backup alternator voltage regulator
- FH6 Battery Bus fuse block
- Two shunts
...
- O-360-A1A engine (Lycon upgraded) with Airperformance fuel injection
- B&C LX60 primary alternator
- B&C SD8 backup alternator
- B&C BCS206 starter
- Bendix magneto (backup ignition)
- Persson Propellers 66P78 propeller on Saber Manufacturing extension
